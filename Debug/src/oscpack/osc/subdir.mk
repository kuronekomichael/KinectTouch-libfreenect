...
src/oscpack/osc/%.o: ../src/oscpack/osc/%.cpp
	...
	g++ -I/usr/include/ni -I"/Users/hardwarehacking/Build/github/KinectTouch/src/oscpack" -I"/Users/hardwarehacking/Build/github/KinectTouch/src/TUIO" -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o"$@" "$<"
